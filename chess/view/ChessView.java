...
/**
 * The ChessView class corresponds to the view component of the MVC design pattern and is linked to
 * the model and the controller class of the chess game. It provides the GUI of the chess game
...
public class ChessView extends JFrame implements View, PropertyChangeListener {
   ...
   * constructor of the JFrame class, initializing the variables model, controller and drawBoard and
   * setting up the GUI that holds the game board. Also, the listeners for the GUI frame are set up.
   *
   * @param model the model that provides the business logic of the game
   * @param controller the class that is responsible for the data manipulation: it updates the
   *     ChessView class with the data that comes from the model
   */
  ...
  /** Opens the dialog that lets the player choose between the modes hotseat, single and network. */
  ...
  /** Creates a dialog window with the options for the network game. */
                  ...
                  try {
                    ...
                    JOptionPane.showMessageDialog(
                        ...
                        "The selected server has not yet "
                            + "been initialized. Please set up a network game as 'Server' "
                            + "in order to do so.");
  ...
  public void handleServerAlreadyInUse() {
    ...
    JOptionPane.showMessageDialog(
        ...
        "This server adress is already in"
            + " use. Please start a network game as 'Client' in order to "
