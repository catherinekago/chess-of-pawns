...
public interface Controller {
  ...
  /**
   * Delegates the model to start the client-server..
   *
   * @throws IOException exception that could occur within network application
   */
  ...
  /**
   * Delegates the model to start the client.
   *
  ...
  /**
   * Handles the mouse click event that occurs in the class view and selects further actions
