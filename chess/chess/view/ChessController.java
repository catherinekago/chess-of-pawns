 ...
 * that is forwarded by the ChessView object and invokes methods of the chess.model or initiates an update
...
public class ChessController implements Controller, PropertyChangeListener {
  ...
  /**
   * Constructs a new object of the class ChessController by setting the given chess.model to its
   * attribute chess.model and initializing the moveStartPoint attribute.
   *
   * @param chess the game chess.model that includes the business logic of the game
   */
  ...
  /**
   * Based on previous choices within the chess.network setup dialog, the chess.model is updated accordingly.
   *
