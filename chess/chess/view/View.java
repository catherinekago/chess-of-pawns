...
/** The main interface of the chess.view. It gets the state it displays directly from the chess.model. */
public interface View extends PropertyChangeListener {
  ...
  /** Handle the case that the server was selected for the chess.network game twice. */
