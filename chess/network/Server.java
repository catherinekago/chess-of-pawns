...
/**
 * The server class of the network chess game. It handles the server initialization and the
...
public class Server {
  ...
  /** Accept socket connections and handle receiving and sending of messages through the network. */
